...
let homeSettings={...DEFAULT_HOME},state={posts:[],filterWorld:null,query:""},editingIndex=null,selectedImage=null,selectedGalleryFiles=[],galleryKeep=[],customCount=0;
...
function parseFrontMatter(text,file=""){
 ...
 return {...meta,name:meta.name||"Untitled",native_name:meta.native_name||"",codename:meta.codename||"",world:meta.world||"",image:meta.image||"",gallery:Array.isArray(meta.gallery)?meta.gallery:[],updated:meta.updated||"",updated_at:meta.updated_at||"",tags:Array.isArray(meta.tags)?meta.tags:[],sections,raw:text,_file:file};
}
